  ...
  return (
    <div className="space-y-20 animate-in fade-in duration-1000 pb-32">
      ...
      <section className="text-center max-w-4xl mx-auto pt-10 px-4">
        ...
        <h1 className="text-4xl md:text-6xl font-black text-white leading-tight uppercase italic italic">
        ...
        <div className="bg-gradient-to-b from-white/[0.03] to-transparent border border-white/5 rounded-[3rem] p-10 md:p-16 flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1 space-y-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed font-medium">
              ...
              quarterly by Tier-1 accounting firms. Our license ensures we
              adhere to the highest standards of global financial conduct.
            </p>
          ...
          <div className="flex-1 w-full max-w-[400px]">
            {/* Abstract placeholder for a security graphic */}
            <div className="aspect-square bg-sky-500/5 border border-sky-500/10 rounded-full flex items-center justify-center relative">
              <div className="absolute inset-0 border border-sky-500/5 rounded-full animate-ping" />
              <HiOutlineGlobeAmericas size={120} className="text-sky-500/20" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="text-center px-4">
        <div className="max-w-xl mx-auto space-y-6">
          ...
          <Link
            to="/register"
            className="bg-white text-black px-10 py-4 rounded-2xl font-black uppercase text-xs tracking-[0.2em] hover:bg-sky-500 transition-all active:scale-95"
          >
            Create Live Account
          </Link>
        </div>
